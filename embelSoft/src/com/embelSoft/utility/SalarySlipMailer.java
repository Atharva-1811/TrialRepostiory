...
public class SalarySlipMailer {
	
	public static void sendFile(String to,File f, String mailId, String mailIdPassword) {

				
		final String user = mailId;// change accordingly
		final String pass = mailIdPassword;
