...
//
//	}
/////////////Today Sale and Purchase Day closure Mail///////////
//public void sendDayClosureFile(String to) {
//
//	final String user = "embelmessanger@gmail.com";// change accordingly
//	final String pass = "Embel@123";
//
...
//		message.setFrom(new InternetAddress(user)); 
//		message.addRecipient(Message.RecipientType.TO,new InternetAddress(to)); 
//		message.setSubject("TEXT FILE FROM EMBEL TECHNOLOGY PVT. LTD, PUNE."); 
//		
//		//3) create MimeBodyPart object and set your message content 
//		MimeBodyPart messageBodyPart1 = new MimeBodyPart(); 
//		messageBodyPart1.setContent("<h1>TEXT<br></h1>","text/html"); 
//		
//
//		//4) create new MimeBodyPart object and set DataHandler object to this object 
//		
...
//		
//		//MimeBodyPart messageBodyPart3 = new MimeBodyPart();			  
//		//String filename2 = "F:\\databackup\\TodayPurchaseReport.csv";//change accordingly //DataSource
//		//DataSource source2 = new FileDataSource(filename2);
//		//messageBodyPart3.setDataHandler(new DataHandler(source2));
//		//messageBodyPart3.setFileName(filename2);
//		
