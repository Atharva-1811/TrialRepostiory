...
public class ClientQuotationBean {
	
	private Long pkQuotationId;
	...
	private int srNo;
	public Long getPkQuotationId() {
		return pkQuotationId;
	}
	public void setPkQuotationId(Long pkQuotationId) {
		this.pkQuotationId = pkQuotationId;
	}
