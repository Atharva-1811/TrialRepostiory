...
<script src="/embelSoft/staticContent/js/componentStockDetails.js"></script>
...
<div class="container-fluid" style="min-height:300px;">
			...
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Component Stock Report</h2>
			</div>
		</div>
	...
	<div id="demo_jui">
	   <table class="table table-bordered table-striped table-condensed cf"
			id="purchaseOrderCreatelist" class="display" style="border: 2px solid black; border-collapse: collapse; width:100%;">
			<thead>
			<tr>
					<th>Sr No</th>
