...
<div class="container" style="min-height:300px;">
	...
	<div class="container">
		...
		<table class="table table-bordered table-striped table-condensed cf"
				...
				<thead>
			<!-- <tr style="background-color: red; color: white;  border-top-left-radius:10px; " > -->
			<tr  >
					<th>Sr No</th>
					<th>Vendor Name</th>
					<th>Date</th>
	...
	<div class="wrapper" align="center">
		<input type="button" style=" font-size: 25" value="Back" id="listBtn" class="btn btn-primary btn-lg btnn" 
		onclick="Back()" /> 
	</div>
