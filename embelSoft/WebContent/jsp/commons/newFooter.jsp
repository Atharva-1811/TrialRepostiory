...
<body>
	<div class="container-fluid">
		<div class=" navbar-fixed-bottom" style="background-color: #36487d;">
			<!-- <div class="col-md-12" class="row footer navbar-fixed-bottom" style="background-color:#8c7674;"> -->
			<!-- <div class="table-responsive"> -->
			<marquee onmouseover="this.stop()" onmouseout="this.start()"
				scrollamount="4" style="padding:13px;">
				<h3 style="color: white;font-size: 15px; font-weight:500;">EMBEL TECHNOLOGIES PVT. LTD. Pune.
					Contact Number: 8275941044</h3>
				<!-- 			   <table class="table">
				<tbody>
					<tr>
						 <div class="btn-group">
