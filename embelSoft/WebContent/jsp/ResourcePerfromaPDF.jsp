...
//				headercn.addCell(table_cell);
		...
		Query query2 = session2.createSQLQuery("select product_name, hsn_sac, unit_price, quantity, GST, IGST, tax_amount, total from resource_billing_perfroma WHERE bill_no = :resourceBillNoForPdf");
		...
		table_cell11 = new  PdfPCell(new Phrase("SERVICE", font11Bold));
		table_cell11.setHorizontalAlignment(Element.ALIGN_CENTER);
		table_cell11.setBorder(Rectangle.LEFT | Rectangle.RIGHT | Rectangle.BOTTOM | Rectangle.TOP);
		table11.addCell(table_cell11);		
