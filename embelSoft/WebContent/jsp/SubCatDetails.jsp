...
{
	window.location = "SubcategoryEdit.jsp";
}
</script>
<script type="text/javascript">
...
<div class="container">
	<div class="row header_margin_top">
		<div align="center">
			<h2 class="form-name style_heading" >Component SubCategory Details</h2>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
	  <p align="center"> Note : Please check Subcategory list before adding a new Subcategory (caution : avoid a duplication and multiple entries)</p>
	</div>
	<div id="wrqpper"> 
    	<form class="form-horizontal" name="componentTypeDetailsForm" id="componentTypeDetailsForm">
				...
				<div class="col-sm-3">
					<div class="input-group">
						...
						<%ComponentTypesDao dao =new ComponentTypesDao();
						   List compList =dao.getAllComponentTypes();
						%>
						<input list="compList" id='componentType' name="componentType" class="form-control" placeholder="Select Category"/>
			...
			<div class="row form-group">
				...
				<div class="col-sm-3">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span> 
						<input type="text" id='componentSubcategory' name="componentSubcategory" class="form-control" placeholder="Enter Component SubCategory"/>
					</div>
				</div>			
			</div>
		<br>
		<div align="center">
			<div class="col-md-12">
				<input type="button" class="btn btn-success btn-lg btnn" value="Save" name="saveBtn" onclick="compSubTypesDetailsValidate();"><!-- checkForDuplicateEntry(); -->
