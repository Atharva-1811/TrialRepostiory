...
<!-- 		<form class="form-horizontal" action="BulkUploadController" method="post" enctype="multipart/form-data">		
 --> 		
 		<form class="form-horizontal" name="compCatBulkForm" id="compCatBulkForm" enctype="multipart/form-data">
...
<!-- 			<input type="file" onchange="this.form.filename.value = this.value" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel"> -->
				...
				<div class="row form-group">
						...
						To download Template of Excel file<a href="../staticContent/fakepath/compoent_category_details.xlsx">&nbsp;&nbsp;&nbsp;Click Here..</a>
						</div>
					</div>
				</div>
...
<!-- 				<input type="submit"  class="btn btn-success btn-lg btnn" value="Save" name="saveBtn">
 -->					
			<input type="button"  class="btn btn-success btn-lg btnn" value="Save" name="saveBtn" onclick="validateCompCatDetails()">					
