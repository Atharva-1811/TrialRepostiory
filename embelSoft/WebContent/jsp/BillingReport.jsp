...
<div  class="col-md-12">
	...
	<ul class="nav nav-tabs">
		<li class=""><a class="leftmanu" href="#enquiry" data-toggle="tab" >Resource Billing Report</a></li>
		<li><a class="leftmanu" href="#followup" data-toggle="tab">Product Billing Report</a></li>
 	</ul>
 	</div>
	<div class="col-xs-9">
            <!-- Tab panes -->
 	...
 	<form class="form-horizontal" method="post" action="" name="emp">
 		<div class="row">
			<div align="center" style="margin-top: 75px">
				<h2 class="form-name style_heading">Resource Billing Report</h2>
			</div>
		</div>
		<div class="row">
    ...
    <form class="form-horizontal" method="post" action="" name="clientReport">
		...
		<div class="row form-group buttons_margin_top ">
			<div align="center">
				<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="getVendorHrBillingDetailsByNameValidation()" value="Search" />
			</div>
		</div>
	<div class="container">  
					<table
						...
						<thead>
							<tr>
								...
								<th>Grid SubTotal</th>
								<th>GridGst Percent</th>
								<th>GridGst Percent Amount</th>
								<th>Total</th>
								<!-- <th>Amount</th> -->
								<th>GST</th>
								<th>VAT</th>
  ...
  <div class="tab-pane" id="followup">
		<form method="post" action="" name="exp">
			<div class="row">
			<div align="center" style="margin-top: 75px">
				  <h2 class="form-name style_heading">Product Billing Report</h2>
			</div>
		</div>
	<div class="row">
		...
		<div class="row form-group buttons_margin_top ">
			<div align="center">
				<input type="button" id="btn" name="save" class="btn btn-lg btn-success btn-md button_hw button_margin_right" onclick="getClientHrBillingDetailsByNameValidation()" value="Search" />
			</div>
		</div>
