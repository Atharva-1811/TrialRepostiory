...
<%@page import="com.embelSoft.bean.ClientPaymentDetailsBean"%>
...
<script type="text/javascript">
   ...
   <div class="container" style="min-height:300px;">
			...
			<div align="center">
				<h2 class="form-name style_heading">Client Payment List</h2>
			</div>
		</div>
 ...
 --%>
	...
	<div class="table-responsive">
	   <table class="table table-bordered table-striped table-condensed cf"
			id="clientPaymentList" class="display" style="border: 1px solid white; border-collapse: collapse; width:100%;">
			<thead>
			<tr>
					<th>Sr No</th>
					<th>Client Name</th>
