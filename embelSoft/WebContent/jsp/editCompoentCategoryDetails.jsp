...
<body>
	...
	<div class="container">
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" >Edit Component Details</h2>
			</div>
		</div>
...
<div id="wrqpper"> 
    <form class="form-horizontal" name="vendorForm">
    		<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								...
								<%
				    	ComponentCategoryDetailsDao dao2 = new ComponentCategoryDetailsDao();
							List compTypeList1 = dao2.getAllCompTnameDetails();
						%> 
							<input list="compoentCategoryNamelist" id='componentName_id'  name="componentName_id" class="form-control" placeholder="Select component Name"onchange="getCompoentCategoryForEdit()">
							<datalist id="compoentCategoryNamelist">
							<%
								for (int i = 0; i < compTypeList1.size(); i++) {
									CompoentCategoryDetailsHibernate ctdh1 = (CompoentCategoryDetailsHibernate) compTypeList1.get(i);
							%>
							<option data-value="<%=ctdh1.getPkComponentCategoryDetailsId()%>" value="<%=ctdh1.getComponentName()%>,<%= ctdh1.getComponentValue()%>,<%= ctdh1.getPackages()%>,<%=ctdh1.getTovRating()%>">									
							<%
								}
							%>
						</datalist>	
					...
					<div class="col-sm-3"style="display: none;">
						<div class="input-group">
							...
							<input type="text" id='componentName11' name="componentName" class="form-control" placeholder="Enter component Name" type="hidden">
				...
				<div class="row form-group">
					...
					<div class="col-sm-3">
						...
						<input list="compoentCategorylist" id='componentCategory' class="form-control" placeholder="Select Component Category" >
				...
				<div class="row form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id="partNumber" name="partNumber" class="form-control" placeholder="Enter Part Number">
						</div>
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input type="text" id='unitPrice' name="unitPrice" class="form-control" placeholder="Enter Unit Price"  onkeyup="unitpriceinclcustomduty()">
						</div>
					</div>
					<div class="col-sm-2" >
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id="duty" name="duty" class="form-control" placeholder="Enter Custom Duty %"  onkeyup="unitpriceinclcustomduty()">
						</div>
					</div>
				...
				<div class="row form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input type="text" id='unitPrice1' name="unitPrice" class="form-control" placeholder="Unit Price Incl Custom duty" readonly="readonly">
						</div>
					</div>
					</div>
			...
			<div align="center">
				<div class="col-md-12">
					<input type="button" class="btn btn-success btn-lg btnn" value="Save" name="btn" onclick="updateCompoentCategoryDetailValidation()"> 
