	...
	Double gstAmt = 0.0;
		...
		//For Company Name
			...
			PdfPCell table_cell;
		        ...
		        table_cell  = new PdfPCell(new Phrase("Bill No:-",Normalfont11));
		        ...
		        table_cell  = new PdfPCell(new Phrase(" Date:- ",Normalfont11));
				table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table_cell.setBorder(Rectangle.NO_BORDER);
				headercn.addCell(table_cell);
		        ...
		        table_cell  = new PdfPCell(new Phrase(" GSTIN:- ",Normalfont11));
				table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table_cell.setBorder(Rectangle.NO_BORDER);
				headercn.addCell(table_cell);
		        ...
		        table_cell  = new PdfPCell(new Phrase(" PAN No:-  ",Normalfont11));
				table_cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
				table_cell.setBorder(Rectangle.NO_BORDER);
				headercn.addCell(table_cell);
...
// 				headercn.addCell(table_cell);
		 ...
		 for(int i=0;i<list12.size();i++)
		{
	 		...
	 		// Table 3
				...
				float[] columnWidths2 = {3f,7f,3f,4f,3f};
			...
			Query query2 = session2.createSQLQuery("select description, hsn, quantity, unit_price, amount from product_billing_details where bill_nos=:proBillNo");
			...
			for(Object[] obj : results2)
			{
				...
				bean.setHsn(obj[1].toString());
				bean.setQuantity(Long.parseLong(obj[2].toString()));
				bean.setBuyPrice(Double.parseDouble(obj[3].toString()));
				bean.setTotal(Double.parseDouble(obj[4].toString()));
				...
				// For Footer	
						...
						try{
							 ...
							 for(int i=0;i<list122.size();i++)
							{
				              ...
				              transport.connect("smtp.gmail.com", 465 ,"sales@embel.co.in","Embel@sales1"); */
