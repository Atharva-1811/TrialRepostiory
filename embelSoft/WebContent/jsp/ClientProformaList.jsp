...
<%@page import="com.embelSoft.hibernate.perfromabillingHibernate"%>
...
<div class="container" style="min-height:300px;">
	<div class="row header_margin_top">
		<div align="center">
			<h2 class="form-name style_heading">Client Proforma Invoice List</h2>
		</div>
	</div>		
	<div class="row">
	...
	<%
		...
		List<perfromabillingHibernate> list = dao.clientPiList();
	%>
			...
			<tbody>		
   				<%
					...
					for(int i=0;i<list.size();i++){
						perfromabillingHibernate bean = (perfromabillingHibernate)list.get(i);	
				%>				
				<tr>
					...
					<td class="align"><%=bean.getSGST()+ bean.getCGST() %></td>
