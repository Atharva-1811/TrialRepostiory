	...
	<div id="wrqpper">
		<form class="form-horizontal" name="userDetailsForm" onsubmit="Validate()">
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
							<input type="text" id='rePassword' name="rePassword" maxlength="12" class="form-control" placeholder="Re Enter Password">
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<!-- 	<div class="col-sm-2" align="right">						
						<label class="control-label" for="selectName">Select User Type&nbsp;:<sup>*</sup></label>
					</div>
          		<div class="col-md-3">
					<div class="input-group">
						<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
				    	<input list="employeeNameList" id="fk_employee_id" class="form-control" onchange="getUserDetailasForEdit()" placeholder="Select User Type">
							<datalist id="employeeNameList">
								<option data-value="employee" value="Employee">
								<option data-value="admin" value="Admin">
								<option data-value="employee2" value="Employee2">
								<option data-value="employee3" value="Employee3">
							</datalist>
					</div>
				</div>	 -->
				...
				<!-- 	<div class="col-sm-2" align="right">
					...
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
							<input type="text" id='userType' name="userType" onkeypress="return isAlphabets(event)" class="form-control" placeholder="Select User Type">
						</div>
					</div> -->
			...
			<div class="container" align="center">
				<input type="button"  class="btn btn-success btn-lg btnn" value="Save" name="saveBtn" onclick="validateUserDetails()"> 
