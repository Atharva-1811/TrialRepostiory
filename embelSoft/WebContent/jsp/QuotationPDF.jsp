...
<%
	...
	try {
		...
		Font font18BoldRed = new Font(Font.FontFamily.TIMES_ROMAN, 18, Font.BOLD, BaseColor.BLACK);
		...
		Font font35RedBold = new Font(Font.FontFamily.TIMES_ROMAN, 35, Font.BOLD, BaseColor.BLACK);
		...
		Query query = session1.createSQLQuery("select product_name, hsn_sac, unit_price, quantity, GST, IGST, tax_amount, total  from quotation_details where quotation_no = :quotationno");
