...
<%
	//String fk_Emp_id = (String) session.getAttribute("fk_Emp_id");
	...
	Double gstAmt = 0.0;
		...
		/* //For Heading
			...
			PdfPCell table_cell;
		        ...
		        table_cell  = new PdfPCell(new Phrase("Experience Certificate ",font12BoldUnderline));
				table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
				table_cell.setBorder(Rectangle.NO_BORDER);
				table1.addCell(table_cell);
 ...
 */
			...
			//For Name
				...
				PdfPCell table_cell2;
				 ...
				 List<ExperienceLetterBean> list12=empList;

		 			int k=0;
		 			
					 for(int i=0;i<list12.size();i++)
					{
						 ExperienceLetterBean sr=(ExperienceLetterBean)list12.get(i);
						...
						String employeeName = sr.getEmployeeName();
					...
					String dateOfJoining = sr.getDateOfJoining();
					String dateOfLeaving = sr.getDateOfLeaving();
					//Long fk_Emp_id = sr.getFk_Emp_id();
					String designation = sr.getDesignation();
					
					table_cell3  = new PdfPCell(new Phrase("Employee ID: "+id,Normalfont13));
					table_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell3.setBorder(Rectangle.NO_BORDER);
					table3.addCell(table_cell3);
					
					table_cell3  = new PdfPCell(new Phrase("Date Of Joining: "+dateOfJoining,Normalfont13));
					table_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell3.setBorder(Rectangle.NO_BORDER);
					table3.addCell(table_cell3);
					
					table_cell3  = new PdfPCell(new Phrase("Date Of Releaving: "+dateOfLeaving,Normalfont13));
					table_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell3.setBorder(Rectangle.NO_BORDER);
					table3.addCell(table_cell3);
					...
					table_cell3  = new PdfPCell(new Phrase("Designation at the time Of Relieving: "+designation,Normalfont13));
					table_cell3.setHorizontalAlignment(Element.ALIGN_LEFT);
					table_cell3.setBorder(Rectangle.NO_BORDER);
					table3.addCell(table_cell3);
					...
					document.add(new Paragraph("",Normalfont13));
					 ...
					 List<ExperienceLetterBean> list13=empList;
					 ...
					 for(int i=0;i<list12.size();i++)
					{
						...
						document.add(new Paragraph(" 								      Mr. /Ms.  " +employeeName+"  is  released  from  the  services  of  the organization  from",Normalfont13 )); 
						
						
					document.add(new Paragraph("closing hours  of  "+ dateOfLeaving + "  subject  to  all  clearances  and  settlement  of  all  dues.\n ",Normalfont13)); 
