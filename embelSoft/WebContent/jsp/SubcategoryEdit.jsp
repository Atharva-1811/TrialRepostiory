...
<div class="container">
	<div class="row header_margin_top">
		<div align="center">
			<h2 class="form-name style_heading" >Edit Component Subcategory</h2>
		</div>
	</div>
	<div class="row">
	...
	<form class="form-horizontal" name="editComponentTypeForm">
			...
			<div class="col-sm-2 col-sm-offset-1" >
				...
				<div class="input-group">
					...
					%>
					<input list="compoentCategorylist" id="componentCategory" class="form-control" placeholder="Select Component Type" onchange="compSubcategoryDetails()">
				...
				<div class="col-sm-2 " >
				<label class=" control-label">Select Subcategory :<sup>*</sup></label>
				</div>
					<div class="col-sm-3">
							<div class="input-group">
								<span class="input-group-addon"> 
									<i class="glyphicon glyphicon-hand-right"></i></span> 									
									<select id="componentSubcategory" name="componentSubcategory" class="form-control" placeholder="Select Subcategory" onchange="getComponentSubcategoryForEdit()"></select>
							</div>
						</div>			
			</div>
					...
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon"> <i
								...
								<input type="text" id="updatedSubCategory" class="form-control" placeholder="Component Subcategory ">
		...
		<div align="center">
			<div class="col-md-12">
				<input type="button" class="btn btn-success btn-lg btnn" value="Update" name="updateBtn" onclick="updateSubcategoryDetailsValidate()"> 
