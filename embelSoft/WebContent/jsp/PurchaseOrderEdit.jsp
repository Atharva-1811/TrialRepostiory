...
<%@page import="com.embelSoft.hibernate.PurchaseOrderCreateHibernateNew"%>
...
<script type="text/javascript">
	...
	{
		document.editPo.gst.value="";
		document.editPo.vat.value="";
		document.editPo.grossTotal.value="";			
	}
</script>
<script type="text/javascript">
	function clearFiled()
...
<div class="container">
	<div class="row header_margin_top">
		<div align="center">
			<h2 class="form-name style_heading">Update Purchase Order</h2>
		</div>
	</div>
	<div class="row">
...
<div id="wrqpper">
	<form class="form-horizontal" name="editPo">
				...
				<div class="col-sm-3">
					<div class="input-group">
						<span class="input-group-addon"><i	class="glyphicon glyphicon-user"></i></span>
							...
							%>
						<input list="vendorNameList" id="fk_vendor_id" class="form-control" onchange="fetchPOEditbillno()">
		...
		<div class="col-sm-2">
			<label class="control-label">PO Bill No :<sup>*</sup></label>
		</div>
		<div class="col-sm-3">
			<div class="input-group">
			 	<span class="input-group-addon"><i class="glyphicon glyphicon-hand-right"></i></span> 			<!-- getVendorDetails() -->
				<select  id='billno' name="billno" class="form-control" placeholder="Select Bill No"  onchange="getPurchaseFieldsInfo(); return getPurchaseGridInfo();"></select>
			<!-- getResourceBillGrid() -->
			</div>
		</div>
	...
	<%-- 	<div class="row">
		...
		<div class="row form-group">
			<div class="table-responsive row" style="padding-top: 20px; padding-bottom: 15px; margin-left: 80px;"">
		   ...
		   <div class="table-responsive	row col-md-offset-1" style="margin-left: 250px;">
...
<!-- 		  
		   ...
		   <div class="row form-group"></div>
		   <div class="row form-group"></div>
			<div class="container" align="center" style="margin-left: 73px;">
				<div class="col-md-10">
					<input type="button" value="Print" class="btn btn-success btn-lg btnn" name="btn" onclick="updatePurchaseOrderValidation()"> 
					<input type="button" value="Cancel" class="btn btn-danger btn-lg btnn" onclick="resets()">
					<input type="button" value="Back" class="btn btn-primary btn-lg btnn" onclick="back()">
				</div>
			</div>
	</form>
	</div>
