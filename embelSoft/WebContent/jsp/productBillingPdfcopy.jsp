...
//response.setHeader("Content-disposition","attachment; filename = ProductbillingCopy.pdf");
	...
	System.out.println("PRODUCT BILLING PDF taxpercentage :- "+taxpercentage);
	int quantCount = 0;
...
//			reports.setLastName(o[10].toString());
		...
		//For Company Name
			...
			PdfPCell table_cell;
				...
				table_cell  = new PdfPCell(new Phrase("Vanashree Palace, 2nd floor, Above Chate Classes,",Normalfont10));
				table_cell.setHorizontalAlignment(Element.ALIGN_LEFT);
				table_cell.setBorder(Rectangle.NO_BORDER);
				headercn.addCell(table_cell);
		 ...
		 /* for(int i=0;i<list12.size();i++)
		{
			 */ GetClientEnquiryDetailsBean sr=(GetClientEnquiryDetailsBean)list12.get(k);
			 ...
			 String businessName = sr.getBusinessName();
				...
				table1.addCell(table_cell1);
			  */
			  table_cell1  = new PdfPCell(new Phrase("Client Details   :-         "+clientNameClientBill,font11Bold));
				table_cell1.setHorizontalAlignment(Element.ALIGN_LEFT);
				table_cell1.setBorder(Rectangle.NO_BORDER);
				table1.addCell(table_cell1);
...
String businessAddress = sr.getBusinessAddress();
		...
		/* } */	
			...
			Query query2 = session2.createSQLQuery("select product_name, hsn_sac, unit_price, quantity, CGST, SGST, IGST, tax_amount, total from product_billing where bill_no=:productBillNo");
