...
function Back() 
{
	window.location = "BillOfMaterial.jsp";
}
</script>
...
<div class="container-fluid" style="min-height:300px;">
			...
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Bill Of Material List</h2>
			</div>
		</div>
		<div class="row">
	   ...
	   <table class="table table-bordered table-striped table-condensed cf"
			...
			<thead>
				<tr>
	                ...
	                <th>Part Number</th>
	                <th>Package</th>
	                <th>Tol V/O Rating</th>
	                <th>Value</th>
					<th>Manufacturer Name</th>
					<th>Description</th>
					<th>Quantity For One Board</th>
					<th>Unit Price</th>
					<th>Board Cost</th>
					<th>Remark</th>
					<th>Vendor Name</th>
